...
import com.mycompany.myapp.repository.RolePermissionRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.RolePermission}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RolePermissionResource {
    ...
    public ResponseEntity<RolePermission> updateRolePermission(@RequestBody RolePermission rolePermission) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, rolePermission.getId().toString()))
            .body(result);
    }
